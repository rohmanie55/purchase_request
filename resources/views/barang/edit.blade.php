                ...
                <div class="card">
                    ...
                    <div class="card-body p-4 row justify-content-center">
                        ...
                        <div class="form-group @error('kd_barang') has-error has-feedback @enderror">
                            ...
                            <input name="kd_barang" value="{{ old('kd_barang') ?? $barang->kd_barang }}" type="text" class="form-control" placeholder="Kode Barang">
                            @error('kd_barang') 
                        ...
                        <div class="form-group @error('nm_brg') has-error has-feedback @enderror">
                            <label>Nama</label>
                            <input name="nm_brg" value="{{ old('nm_brg') ?? $barang->nm_brg }}" type="text" class="form-control" placeholder="Nama">
                            @error('nm_brg') 
                            <small class="form-text text-danger">
                                <strong>{{ $message }}</strong>
                            </small> 
                        ...
                        <div class="form-group @error('unit') has-error has-feedback @enderror">
                            <label>Unit</label>
                            <input name="unit" value="{{ old('unit') ?? $barang->unit }}" type="text" class="form-control" placeholder="Unit (PCS, SET)">
                            @error('unit') 
                            <small class="form-text text-danger">
                                <strong>{{ $message }}</strong>
                            </small> 
                        ...
                        <div class="form-group @error('harga') has-error has-feedback @enderror">
                            <label>Harga</label>
                            <input name="harga" value="{{ old('harga') ?? $barang->harga }}" type="text" class="form-control" placeholder="Harga">
                            @error('harga') 
                            <small class="form-text text-danger">
                                <strong>{{ $message }}</strong>
                            </small> 
                        ...
                        <div class="form-group @error('stock') has-error has-feedback @enderror">
                            <label>Stock</label>
                            <input name="stock" value="{{ old('stock') ?? $barang->stock }}" type="number" class="form-control" placeholder="Stock">
                            @error('stock') 
                            <small class="form-text text-danger">
                                <strong>{{ $message }}</strong>
                            </small> 
